...
class MemNet(nn.Module):
    def __init__(self, args, in_channels=3, channels=64, num_memblock=3, num_resblock=3):
...
class BNReLUConv(nn.Sequential):
    def __init__(self, in_channels, channels, inplace=True):
        ...
        self.add_module('bn', nn.BatchNorm2d(num_features=in_channels, eps=1e-05, momentum=0.1, affine=True))
