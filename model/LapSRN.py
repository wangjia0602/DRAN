...
class _Conv_Block(nn.Module):
    def __init__(self):
        ...
        # print(self.cov_block[0].weight.type)
...
class Net(nn.Module):
    def __init__(self, args):
        ...
        # print(self.conv_input.weight.type)

        self.convt_I1 = nn.ConvTranspose2d(in_channels=3, out_channels=3, kernel_size=4, stride=2, padding=1,
                                           bias=False)
        ...
        self.convt_I2 = nn.ConvTranspose2d(in_channels=3, out_channels=3, kernel_size=4, stride=2, padding=1,
                                           bias=False)
